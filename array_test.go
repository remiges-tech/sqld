...
func TestValidatorAcceptsOpOverlapOnArrayField(t *testing.T) {
	err := Register[ArrayTestModel]()
	require.NoError(t, err)
...
func TestValidatorRejectsOpOverlapWithScalarValue(t *testing.T) {
	err := Register[ArrayTestModel]()
	require.NoError(t, err)
...
func TestBuildQueryWithOpOverlap(t *testing.T) {
	err := Register[ArrayTestModel]()
	require.NoError(t, err)
